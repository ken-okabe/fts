...
//---
input color ExtColor1 = Coral;    // Shadow of bear candlestick
input color ExtColor2 = DarkGreen;  // Shadow of bull candlestick
input color ExtColor3 = Coral;    // Bear candlestick body
input color ExtColor4 = DarkGreen;  // Bull candlestick body
//--- buffers
